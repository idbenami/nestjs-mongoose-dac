import { VirtualsFactory } from '../../src';
import { VirtualMetadataInterface } from '@nestjs/mongoose/dist/metadata/virtual-metadata.interface';
  ...
  describe('Schema virtual definition', () => {
    ...
    it('should define virtuals for each stored virtual metadata linked to the schema model', () => {
      ...
      expect(schemaMock.virtual['mock'].calls).toEqual([
        ...
        [virtualMetadataWithOptionsMock.name, virtualMetadataWithOptionsMock.options],
      ]);
    });
  });
